...
SECRET_KEY = 'django-insecure-a^r)0(6ai0ohggbbxy+wn+-e75e%bbgo#be+6v()vd3@*+nl%^'
...
REST_FRAMEWORK={
    'DEFAULT_AUTHENTICATION_CLASSES':{
        'rest_framework_simplejwt.authentication.JWTAuthentitcation',
    }
}
...
AUTH_USER_MODEL = 'users.CustomUser'  # Usa el nombre correcto de la app
